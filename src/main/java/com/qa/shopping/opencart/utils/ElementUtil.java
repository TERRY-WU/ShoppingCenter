package com.qa.shopping.opencart.utils;
...
public class ElementUtil {
	...
	/**
	 * visibilityOfElementLocated is used for checking that an element is present on the DOM of a page and visible.
	 * Means it uses By object instead of WebElement object with callable function to find that element first then check that element is visible or not.
	 *
	 * visibilityOf is used for checking that an element, known to be present on the DOM of a page, is visible.
	 * Means you have already found that element and just check only for that visibility.
	 */
